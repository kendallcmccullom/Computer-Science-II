...
public class SeussWords
{
	...
	public static void main (String [] args)
	{
		try
		{
			...
			Set<String> words = new ArraySet<String>(); //create set
			...
			outFile.println("Here are all the words in Dr.Suess' Green Eggs and Hamt:\n");
			int count = 0;
			while (iter.hasNext())
			{
			...
			outFile.println("\nThere are a total of " + count + " different words in the book.");
			inFile.close();
			outFile.close();	
		}
